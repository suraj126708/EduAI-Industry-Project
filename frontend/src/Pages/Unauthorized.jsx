...
import { FaLock, FaHome, FaArrowLeft, FaGraduationCap } from "react-icons/fa";
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          You don't have permission to access this ExamFlow feature
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="text-center">
            <p className="text-gray-600 mb-6">
              Sorry, you don't have the required permissions to view this
              ExamFlow feature. Please contact your school administrator if you
