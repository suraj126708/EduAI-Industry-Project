...
import { FaTachometerAlt, FaUsers, FaFileAlt, FaChartBar } from "react-icons/fa";
...
const AdminLayout = () => (
  <div className="flex min-h-screen bg-gradient-to-r from-indigo-50 via-white to-indigo-100">
    <aside className="w-64 bg-white border-r shadow-sm flex flex-col py-8 px-4">
      <span className="text-xl font-bold text-indigo-700 mb-8 tracking-tight">Admin Panel</span>
